...
export default function PlayerCard({name, width, height, greyedOut=false}){
    return(<div className={` tooltip relative w-[${width}px] mt-10 tooltip-open h-[${height}px]`} data-tip={name}>
        ...
        {/* center */}
        <Image src={greyedOut?"/dried_blood.png":"/blood.png"} width={width} height={height} alt="blood" className="rounded-full absolute inset-0 z-10 scale-[85%] opacity-90" />
